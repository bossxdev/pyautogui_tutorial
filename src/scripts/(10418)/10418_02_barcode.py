...
def run_test_case():
    ...
    try:
        ...
        write_text("010754600005902", delay=3, description="กรอกบาร์โค้ดส่วนแรก")
        state("automation_test", log_level="INFO", message="กรอกบาร์โค้ดส่วนแรกสำเร็จ")

        pyautogui.keyDown('shift')
        pyautogui.press('\\')
        pyautogui.keyUp('shift')
        write_text("004", delay=20, description="กรอกบาร์โค้ดส่วนที่สอง")
        state("automation_test", log_level="INFO", message="กรอกรหัสสาขาสำเร็จ")
        
        pyautogui.keyDown('shift')
        pyautogui.press('\\')
        pyautogui.keyUp('shift')
        write_text("00463020012", delay=20, description="กรอกบาร์โค้ดส่วนทีสาม")
        state("automation_test", log_level="INFO", message="กรอกหมายเลขอ้างอิงสำเร็จ")
        
        
        pyautogui.keyDown('shift')
        pyautogui.press('\\')
        pyautogui.keyUp('shift')
        write_text("1632500", delay=6, description="กรอกบาร์โค้ดส่วนที่สี่")

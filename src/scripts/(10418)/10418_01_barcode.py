...
def run_test_case():
    ...
    try:
        ...
        write_text("010754600005901", delay=3, description="กรอกบาร์โค้ดส่วนแรก")
        ...
        pyautogui.press('\\')
        pyautogui.keyUp('shift')
        write_text("12345678901", delay=20, description="กรอกบาร์โค้ดส่วนทีสาม")
        ...
        pyautogui.press('\\')
        pyautogui.keyUp('shift')
        write_text("49000", delay=6, description="กรอกบาร์โค้ดส่วนที่สี่")

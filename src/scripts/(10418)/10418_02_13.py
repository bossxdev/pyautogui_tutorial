...
def run_test_case():
    ...
    try:
        ...
        state("S02_15test", level="INFO", message="คลิกเลือกชำระสินค้าเเละบริการ")
        time.sleep(10)
        
        write_text("004", delay=4, description="รหัสสาขา")
        state("automation_test", level="INFO", message="รหัสสาขา")
        pyautogui.press('enter')
        write_text("00463020012", delay=4, description="หมายเลขอ้างอิง")
        state("automation_test", level="INFO", message="หมายเลขอ้างอิง")
        pyautogui.press('enter')

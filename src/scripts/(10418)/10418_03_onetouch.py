...
def run_test_case():
    ...
    try:
       ...
       # คลิกปุ่มผู้ว่าจ้าง
        ...
        state("S02_15test", log_level="INFO", message="กรอกไมด้า เเอสเซ็ท")
        pyautogui.press('enter')

   # คลิกเลือกมูลนิธิเพื่อนหญิง
        click((298, 131), delay=5, description="คลิกเลือกไมด้า เเอสเซ็ท")
        state("S02_15test", log_level="INFO", message="คลิกเลือกไมด้า เเอสเซ็ท")
        time.sleep(10)
      
        click((361, 339), delay=5, description="คลิกเลือกชำระค่่าสินค้าเเละบริการ")
        state("S02_15test", log_level="INFO", message="คลิกเลือกชำระค่่าสินค้าเเละบริการสำเร็จ")
        time.sleep(10)
        ...
        write_text("00463020012", delay=4, description="กรอกหมายเลขอ้างอิง")

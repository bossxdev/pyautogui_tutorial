...
def run_test_case():
    ...
    try:
        ...
        write_text("099400007263500", delay=2, description="กรอกรหัสบาร์โค้ด")
        ...
        # log_handler("S02_15test", log_level="INFO", log_message="คลิกเลือกค่าธรรมเนียมต่างสำเร็จ")
        # time.sleep(10)
        
        write_text("A12345678", delay=4, description="กรอกรหัสกิจกรรม")
        log_handler("automation_test", log_level="INFO", log_message="กรอกรหัสกิจกรรม")
        pyautogui.press('enter')

        write_text("1234", delay=4, description="กรอกเลขที่อ้างอิง1")
        log_handler("automation_test", log_level="INFO", log_message="กรอกเลขที่อ้างอิง1")
        pyautogui.press('enter')

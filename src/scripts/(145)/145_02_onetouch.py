...
def run_test_case():
    ...
    try:
       ...
       # คลิกปุ่มผู้ว่าจ้าง
        ...
        log_state("S02_15test", log_level="INFO", log_message="กรอกมูลนิธิสันติสุธสำเร็จ")
        pyautogui.press('enter')

   # คลิกเลือกมูลนิธิสันติสุธ
        click((298, 131), delay=5, description="คลิกเลือกมูลนิธิสันติสุธ")
        log_state("S02_15test", log_level="INFO", log_message="คลิกเลือกมูลนิธิสันติสุธ")
        time.sleep(10)
 
        click((361, 339), delay=5, description="คลิกเลือกรับบริจาค")
        log_state("S02_15test", log_level="INFO", log_message="คลิกเลือกรับบริจาค")
        time.sleep(10)

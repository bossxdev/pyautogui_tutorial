...
def run_test_case():
    try:
        ...
        write_text("010755100015105", delay=2, description="กรอกบาร์โค้ด")
        log_state("test_case", "INFO", "กรอกบาร์โค้ด: 010755100015105")
        
        click((480, 464), delay=50, description="คลิกปุ่มยืนยัน pop up บาร์โค้ด")
        ...
        write_text("100", delay=2, description="กรอกจำนวนเงิน")

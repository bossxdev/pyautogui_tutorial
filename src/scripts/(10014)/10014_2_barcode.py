...
def run_test_case():
    ...
    try:
        ...
        log_handler("automation_test", log_level="INFO", log_message="กรอกรหัส Shop/Vansaleสำเร็จ")
        
        pyautogui.keyDown('shift')
        pyautogui.press('\\')
        pyautogui.keyUp('shift')
        write_text("123", delay=20, description="กรอกบาร์โค้ดส่วนที่สอง")
        log_handler("automation_test", log_level="INFO", log_message="กรอกเลขผู้เสียภาษาษี")

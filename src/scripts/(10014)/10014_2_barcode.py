...
def run_test_case():
    ...
    try:
        ...
        write_text("010753700137402", delay=3, description="กรอกบาร์โค้ดส่วนแรก")
        ...
        state("automation_test", log_level="INFO", log_message="กรอกรหัส Shop/Vansaleสำเร็จ")
        
        pyautogui.keyDown('shift')
        pyautogui.press('\\')
        pyautogui.keyUp('shift')
        write_text("123", delay=20, description="กรอกบาร์โค้ดส่วนที่สอง")
        state("automation_test", log_level="INFO", log_message="กรอกเลขผู้เสียภาษาษี")

        pyautogui.keyDown('shift')
        pyautogui.press('\\')
        pyautogui.keyUp('shift')
        write_text("30000", delay=6, description="กรอกบาร์โค้ดส่วนที่สาม")

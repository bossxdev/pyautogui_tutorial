...
def setup_environment():
    ...
    try:
        ...
        log_state("automation_test", log_level="ERROR", log_message=f"เกิดข้อผิดพลาดระหว่างการตั้งค่าระบบ: {e}")
        raise
...
def run_test_case():
    ...
    try:
        ...
        try:
            ...
            log_state("automation_test", log_level="ERROR", log_message=f"ข้อผิดพลาดจากการคลิกปุ่มกรอกบาร์โค้ด: {e}")
            raise
        except Exception as e:
            log_state("automation_test", log_level="ERROR", log_message=f"เกิดข้อผิดพลาดในการคลิกปุ่มกรอกบาร์โค้ด: {e}")
            raise
        ...
        try:
            ...
            log_state("automation_test", log_level="ERROR", log_message=f"ข้อผิดพลาดจากการกรอกรหัสบาร์โค้ด: {e}")
            raise
        except Exception as e:
            log_state("automation_test", log_level="ERROR", log_message=f"เกิดข้อผิดพลาดในการกรอกรหัสบาร์โค้ด: {e}")
            raise
        ...
        try:
            ...
            log_state("automation_test", log_level="ERROR", log_message=f"ข้อผิดพลาดจากการกรอกรหัสลูกค้า: {e}")
            raise
        except Exception as e:
            if "กรุณาคีย์ รหัสลูกค้า" in str(e):
                log_state("automation_test", log_level="ERROR", log_message=f"กรุณาคีย์ รหัสลูกค้า: {e}")
            else:
                log_state("automation_test", log_level="ERROR", log_message=f"ข้อมูลไม่ถูกต้อง: {e}")
            raise

        # กรอกเลขผู้เสียภาษี
        try:
            write_text("1234567893434", delay=4, description="กรอกเลขผู้เสียภาษี")
            log_state("automation_test", log_level="INFO", log_message="กรอกเลขผู้เสียภาษีสำเร็จ")
            pyautogui.press('enter')
        except pyautogui.FailSafeException as e:
            log_state("automation_test", log_level="ERROR", log_message=f"ข้อผิดพลาดจากการกรอกเลขผู้เสียภาษี: {e}")
        ...
        try:
            ...
            log_state("automation_test", log_level="ERROR", log_message=f"ข้อผิดพลาดจากการกรอกจำนวนเงิน: {e}")
            raise
        except Exception as e:
            log_state("automation_test", log_level="ERROR", log_message=f"เกิดข้อผิดพลาดในการกรอกจำนวนเงิน: {e}")
            raise
        ...
        try:
            ...
            log_state("automation_test", log_level="ERROR", log_message=f"ข้อผิดพลาดจากการคลิกปุ่มยืนยันทำรายการ: {e}")
            raise
        except Exception as e:
            log_state("automation_test", log_level="ERROR", log_message=f"เกิดข้อผิดพลาดในการยืนยันทำรายการ: {e}")
            raise
        ...
        try:
            ...
            log_state("automation_test", log_level="ERROR", log_message=f"ข้อผิดพลาดจากการคลิกปุ่มยืนยันชำระเงิน: {e}")
            raise
        except Exception as e:
            log_state("automation_test", log_level="ERROR", log_message=f"เกิดข้อผิดพลาดในการยืนยันชำระเงิน: {e}")
            raise
        ...
        try:
            ...
            log_state("automation_test", log_level="ERROR", log_message=f"ข้อผิดพลาดจากการคลิกปุ่มรับพอดี: {e}")
        except Exception as e:
            log_state("automation_test", log_level="ERROR", log_message=f"เกิดข้อผิดพลาดในการคลิกปุ่มรับพอดี: {e}")
            raise
        ...
        try:
            ...
            log_state("automation_test", log_level="ERROR", log_message=f"ข้อผิดพลาดจากการคลิกปุ่มยืนยันการชำระเงิน: {e}")
            raise
        except Exception as e:
            log_state("automation_test", log_level="ERROR", log_message=f"เกิดข้อผิดพลาดในการยืนยันการชำระเงิน: {e}")
            raise

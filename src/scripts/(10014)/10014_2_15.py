...
def run_test_case():
    ...
    try:
        ...
        write_text("010753700137402", delay=2, description="กรอกรหัสบาร์โค้ด")
        ...
        write_text("123456789", delay=4, description="กรอกรหัส Shop/Vansale")
        state("automation_test", log_level="INFO", log_message="กรอกรหัส Shop/Vansaleสำเร็จ")
        pyautogui.press('enter')

        write_text("123", delay=4, description="กรอกเลขผู้เสียภาษาษี")
        state("automation_test", log_level="INFO", log_message="กรอกรหัส Shop/Vansaleสำเร็จ")
        pyautogui.press('enter')
        ...
        time.sleep(20)
        # กรอกจำนวนเงิน
        write_text("30000", delay=4, description="กรอกลำดับที่สาขา")
        state("automation_test", log_level="INFO", log_message="กรอกลำดับที่สาขาสำเร็จ")

...
def run_test_case():
   ...
   # คลิกเลือกมูลนิธิเพื่อนหญิง
        ...
        time.sleep(10)
        click((352, 396), delay=5, description="คลิกเลือกค่าสินค้า Cashsale")
        log_handler("S02_15test", log_level="INFO", log_message="คลิกเลือกค่าสินค้า Cashsale สำเร็จ")
        time.sleep(10)
        
        write_text("123456789", delay=4, description="กรอกรหัส Cashsale")
        pyautogui.press('enter')

        log_handler("automation_test", log_level="INFO", log_message="กรอกรหัส Cashsale สำเร็จ")

...
def run_test_case():
    ...
    try:
       ...
       # คลิกปุ่มผู้ว่าจ้าง
        ...
        log_state("S02_15test", log_level="INFO", log_message="กรอกผ่าตัดเเก้ไขใบหน้าให้น้อง")
        pyautogui.press('enter')

   # คลิกเลือกมูลนิธิเพื่อนหญิง
        click((298, 131), delay=5, description="คลิกเลือกผ่าตัดเเก้ไขใบหน้าให้น้อง")
        log_state("S02_15test", log_level="INFO", log_message="คลิกเลือกผ่าตัดเเก้ไขใบหน้าให้น้อง")
        time.sleep(10)

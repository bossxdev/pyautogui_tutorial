...
def run_test_case():
    ...
    try:
        ...
        write_text("0994000575955", delay=2, description="กรอกรหัสบาร์โค้ด")
        ...
        log_state("S02_15test", log_level="INFO", log_message="คลิกเลือกค่านํ้าประปาสำเร็จ")
        time.sleep(10)
        ...
        write_text("29116740", delay=4, description="กรอกเลขที่อ้างอิง2")
        log_state("automation_test", log_level="INFO", log_message="กรอกเลขที่อ้างอิง2")
        pyautogui.press('enter')
        ...
        time.sleep(20)
        # กรอกจำนวนเงิน
        write_text("200.75", delay=4, description="กรอกจำนวนเงิน")

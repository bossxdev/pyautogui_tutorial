...
def run_test_case():
    ...
    try:
       ...
       # คลิกปุ่มผู้ว่าจ้าง
        ...
        log_state("S02_15test", log_level="INFO", log_message="กรอกบ.เสริมธนาทรัพ์สำเร็จ")
        pyautogui.press('enter')

   # คลิกเลือกบ.เสริมธนาทรัพ์
        click((298, 131), delay=5, description="คลิกเลือกบ.เสริมธนาทรัพ์")
        log_state("S02_15test", log_level="INFO", log_message="คลิกเลือกบ.เสริมธนาทรัพ์สำเร็จ")
        time.sleep(10)
     
        click((361, 339), delay=5, description="คลิกเลือกจักรยานยนต์")
        log_state("S02_15test", log_level="INFO", log_message="คลิกเลือกจักรยานยนต์สำเร็จ")

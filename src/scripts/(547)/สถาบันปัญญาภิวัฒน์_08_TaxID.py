...
def run_test_case():
    try:
        ...
        write_text("0994000633980",delay=2, description="กรอกบาร์โค้ด")
        log_state("test_case", "INFO", "กรอกบาร์โค้ด: 0994000633980")
        ##รอ remote 
        ...
        log_state("test_case", "INFO", "กรอกรหัสพนักงาน")
        
        pyautogui.press("enter")
        time.sleep(3)

        write_text("00123431", delay=3, description="กรอกเลขที่สัญญา")
        log_state("test_case", "INFO", "กรอกเลขที่สัญญา")

        pyautogui.press("enter") #เบอร์ 0865562828
        time.sleep(20)
        
        write_text("49000", delay=3, description="กรอกจำนวนเงิน")

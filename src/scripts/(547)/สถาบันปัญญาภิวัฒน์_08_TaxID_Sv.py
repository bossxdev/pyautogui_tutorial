...
def run_test_case():
    try:
        ...
        log_state("test_case", "INFO", "กรอกบาร์โค้ด: 099400063398008")
        ...
        write_text("4900", delay=3, description="กรอกจำนวนเงิน 49000")
        log_state("test_case", "INFO", "กรอกจำนวนเงิน 49000")

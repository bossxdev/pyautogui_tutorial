...
def run_test_case():
    ...
    try:
       ...
       # คลิกปุ่มผู้ว่าจ้าง
        ...
        log_state("S02_15test", log_level="INFO", log_message="กรอกบริษัท อีซี่อินชัวร์ โบรกเกอร์ จำกัดสำเร็จ")
        pyautogui.press('enter')

        click((298, 131), delay=5, description="คลิกเลือกบริษัท อีซี่อินชัวร์ โบรกเกอร์ จำกัด")
        log_state("S02_15test", log_level="INFO", log_message="คลิกเลือกบริษัท อีซี่อินชัวร์ โบรกเกอร์ จำกัดสำเร็จ")
        time.sleep(10)
        
         # คลิกเลือก service

        click((361, 339), delay=5, description="คลิกเลือกประกันอีซี่")
        log_state("S02_15test", log_level="INFO", log_message="คลิกเลือกประกันอีซี่สำเร็จ")
        
        write_text("1132202124125", delay=3, description="กรอกรหัสประชาชน")
        pyautogui.press('enter')
        
        write_text("0856595555", delay=3, description="กรอกเบอร์มือถือ")
        pyautogui.press('enter')

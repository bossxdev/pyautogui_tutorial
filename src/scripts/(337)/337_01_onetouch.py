...
def run_test_case():
    ...
    try:
       ...
       # คลิกปุ่มผู้ว่าจ้าง
        ...
        state("S02_15test", log_level="INFO", message="กรอกบริษัท อีซี่อินชัวร์ โบรกเกอร์ จำกัดสำเร็จ")
        pyautogui.press('enter')

        click((298, 131), delay=5, description="คลิกเลือกบริษัท อีซี่อินชัวร์ โบรกเกอร์ จำกัด")
        state("S02_15test", log_level="INFO", message="คลิกเลือกบริษัท อีซี่อินชัวร์ โบรกเกอร์ จำกัดสำเร็จ")
        time.sleep(10)
        
         # คลิกเลือก service

        click((361, 339), delay=5, description="คลิกเลือกประกันอีซี่")
        state("S02_15test", log_level="INFO", message="คลิกเลือกประกันอีซี่สำเร็จ")

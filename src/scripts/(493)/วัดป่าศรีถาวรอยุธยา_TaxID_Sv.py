...
def run_test_case():
    try:
        ...
        write_text("493020000000002", delay=2, description="กรอกบาร์โค้ด")
        log_state("test_case", "INFO", "กรอกบาร์โค้ด: 493020000000002")

        
        click((490, 470), delay=30, description="คลิกปุ่มยืนยัน pop up บาร์โค้ด")
        log_state("test_case", "INFO", "ยืนยัน pop up บาร์โค้ด")
        
        write_text("10", delay=2, description="กรอกจำนวนเงิน")

...
def run_test_case():
    try:
        ...
        log_state("test_case", "INFO", "กรอกบาร์โค้ด: 099400077225412")
        
        click((480, 464), delay=20, description="คลิกปุ่มยืนยัน pop up บาร์โค้ด")
        log_state("test_case", "INFO", "คลิกปุ่มยืนยัน pop up บาร์โค้ด")
        
        write_text("156010002612986", delay=3, description="")
        log_state("test_case", "INFO", "156010002612986")
        
        pyautogui.press("enter")
        time.sleep(10)
        
        write_text("642021385017151167", delay=3, description="")

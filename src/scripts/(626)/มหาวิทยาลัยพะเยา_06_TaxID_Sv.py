...
def run_test_case():
    try:
        ...
        state("test_case", "INFO", "กรอกบาร์โค้ด: 099400077225406")
        
        click((480, 464), delay=20, description="คลิกปุ่มยืนยัน pop up บาร์โค้ด")
        state("test_case", "INFO", "ยืนยัน pop up บาร์โค้ด")
        ...
        state("test_case", "INFO", "กรอกจำนวนเงิน")
        ...
        state("test_case", "DEBUG", "การทดสอบเสร็จสมบูรณ์")
        
    except Exception as e:
        state("test_case", "DEBUG", f"เกิดข้อผิดพลาดระหว่างการทดสอบ: {str(e)}")
        raise

...
def run_test_case():
    ...
    try:
       ...
       # คลิกปุ่มผู้ว่าจ้าง
        ...
        # คลิกปุ่มผู้ว่าจ้าง
        click((212, 340), delay=7, description="คลิกปุ่มชำระค่าสินค้า/ขายตรง/หนังสือ")
        log_handler("S02_15test", log_level="INFO", log_message="คลิกปุ่มสำเร็จ")
               # คลิกปุ่มผู้ว่าจ้าง
        click((74, 218), delay=7, description="คลิกปุ่มชำระค่าสินค้า")
        log_handler("S02_15test", log_level="INFO", log_message="คลิกปุ่มชำระค่าสินค้าสำเร็จ")
               # คลิกปุ่มผู้ว่าจ้าง
        click((509, 649), delay=7, description="คลิกปุ่มถัดไป")
        log_handler("S02_15test", log_level="INFO", log_message="คลิกปุ่มถัดไปสำเร็จ")
        time.sleep(10)


   # คลิกเลือกมูลนิธิเพื่อนหญิง
        click((69, 336), delay=5, description="คลิกเลือกบริษัท อาร์ แอนด์ ดับบลิว แฟคตอริ่ง จำกัด")
        log_handler("S02_15test", log_level="INFO", log_message="คลิกเลือกบริษัท อาร์ แอนด์ ดับบลิว แฟคตอริ่ง จำกัด")
        time.sleep(10)

...
def run_test_case():
    try:
        ...
        write_text("099300007024101", delay=2, description="กรอกบาร์โค้ด")
        log_state("test_case", "INFO", "กรอกบาร์โค้ด: 0993000070241")

        click((479, 456), delay=30, description="คลิกปุ่มยืนยัน pop up บาร์โค้ด")
        log_state("test_case", "INFO", "ยืนยัน pop up บาร์โค้ด")

        # click((370, 275), delay=30, description="คลิกเลือก service")
        # log_state("test_case", "INFO", "เลือก service")

        write_text("100", delay=5, description="กรอกจำนวนเงิน")
        log_state("test_case", "INFO", "กรอกจำนวนเงิน: 5000")

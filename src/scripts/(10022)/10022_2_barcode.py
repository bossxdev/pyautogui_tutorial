...
def run_test_case():
    ...
    try:
        ...
        write_text("099400147613602", delay=3, description="กรอกบาร์โค้ดส่วนแรก")
        state("automation_test", log_level="INFO", log_message="กรอกบาร์โค้ดส่วนแรกสำเร็จ")

        pyautogui.keyDown('shift')
        pyautogui.press('\\')
        pyautogui.keyUp('shift')
        write_text("111111111119", delay=20, description="กรอกบาร์โค้ดส่วนที่สอง")
        ...
        pyautogui.press('\\')
        pyautogui.keyUp('shift')
        write_text("110.75", delay=6, description="กรอกบาร์โค้ดส่วนที่สาม")

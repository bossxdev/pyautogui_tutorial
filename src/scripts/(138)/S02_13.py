...
def run_test_case():
    ...
    try:
        ...
        state("S02_15test", level="INFO", message="คลิกปุ่มกรอกบาร์โค้ดสำเร็จ")
        ...
        time.sleep(15)
        state("S02_15test", level="INFO", message="กรอกรหัสบาร์โค้ดสำเร็จ")
        
        click((494, 526), delay=5, description="คลิกไปหน้าถัดไป")
        state("S02_15test", level="INFO", message="คลิกไปหน้าถัดไป")

        
        click((361, 339), delay=5, description="คลิกเลือกตู้บุญเติม")
        state("S02_15test", level="INFO", message="คลิกเลือกตู้บุญเติมสำเร็จ")

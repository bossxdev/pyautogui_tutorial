...
def run_test_case():
    ...
    try:
       ...
       # คลิกปุ่มผู้ว่าจ้าง
        ...
        state("S02_15test", log_level="INFO", log_message="กรอก บริษัท สมใจ 2559 จำกัด")
        pyautogui.press('enter')

   # คลิกเลือกมูลนิธิเพื่อนหญิง
        click((298, 131), delay=5, description="คลิกเลือก บริษัท สมใจ 2559 จำกัด")
        state("S02_15test", log_level="INFO", log_message="คลิกเลือก บริษัท สมใจ 2559 จำกัดสำเร็จ")
        time.sleep(10)
 
        write_text("123", delay=4, description="กรอกเลขที่อ้างอิง1")
        state("automation_test", log_level="INFO", log_message="กรอกเลขที่อ้างอิง1สำเร็จ")
        pyautogui.press('enter')
        write_text("12345678901", delay=4, description="กรอกเลขที่อ้างอิง2")
        state("automation_test", log_level="INFO", log_message="กรอกเลขที่อ้างอิง2สำเร็จ")
        pyautogui.press('enter')

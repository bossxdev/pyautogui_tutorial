...
def create_logger(logger_name: str, level: str = "DEBUG", log_message: str = None):
    """
    ...
    stream_handler.setLevel(log_level)  # ใช้ log level ที่ได้จากพารามิเตอร์
    ...
    log_filename = f"../logs/{logger_name}_{current_time}.log"

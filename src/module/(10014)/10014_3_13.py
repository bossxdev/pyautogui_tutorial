...
def run_test_case():
    ...
    try:
        ...
        log_handler("S02_15test", log_level="INFO", log_message="คลิกเลือกค่าสินค้า Cashsaleสำเร็จ")
        time.sleep(10)
        
        write_text("123456789", delay=4, description="กรอกรหัส Cashsale")
        log_handler("automation_test", log_level="INFO", log_message="กรอกรหัส Cashsaleสำเร็จ")
        pyautogui.press('enter')

        write_text("1234567891", delay=4, description="กรอกรหัสพนักงาน")
        log_handler("automation_test", log_level="INFO", log_message="กรอกรหัสพนักงานสำเร็จ")
        pyautogui.press('enter')
        ...
        time.sleep(20)
        # กรอกจำนวนเงิน
        write_text("50000", delay=4, description="กรอกจำนวนเงิน")

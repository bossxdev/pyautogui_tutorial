...
def run_test_case():
    ...
    write_text("099400001123700", delay=3, description="กรอกบาร์โค้ด 1")

    # กรอกรหัสอ้างอิง
    write_text("12345678901", delay=3, description="กรอกรหัสอ้างอิง")
    time.sleep(14)

    # กรอกเบอร์โทรศัพท์
    write_text("49000", delay=2, description="กรอกเบอร์โทรศัพท์")

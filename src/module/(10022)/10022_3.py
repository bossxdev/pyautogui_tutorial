...
def run_test_case():
    ...
    # คลิกเลือกค่าธรรมเนียมนักเรียนเก่า
    click((388, 402), delay=20, description="คลิกเลือกค่าธรรมเนียมนักเรียนเก่า")

    # รอให้การทำงานเสร็จสิ้น (กรณีเชื่อมต่อกับเครื่อง EDC หรืออื่นๆ)
    log_action("Wait", "รอการทำงานจากเครื่อง EDC")

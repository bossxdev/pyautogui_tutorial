...
def run_test_case():
    ...
    click((381, 343), delay=20, description="คลิกเลือกค่าธรรมเนียมนักเรียนใหม่")

    # กรอกรหัสอ้างอิง
    write_text("11111111111119", delay=2, description="กรอกรหัสอ้างอิง 1")
    ...
    write_text("110.75", delay=2, description="กรอกเบอร์โทรศัพท์จากเครื่อง EDC")

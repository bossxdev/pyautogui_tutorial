...
def run_test_case():
    ...
    write_text("102990000000000", delay=3, description="กรอกบาร์โค้ด 1")

    pyautogui.keyDown('shift')
    pyautogui.press('\\')
    pyautogui.keyUp('shift')
    write_text("30000", delay=2, description="กรอกรหัสอ้างอิง 1")

    pyautogui.write("30000", delay=2, description="กรอกเบอร์โทรศัพทจากเครื่อง EDC")

...
def run_test_case():
    ...
    pyautogui.write("099400077225406")
    time.sleep(2)
    
    pyautogui.click(480, 464, button="left")
    time.sleep(20)
    
    pyautogui.write("1749700015973")
    time.sleep(3)
    
    pyautogui.press("enter")
    time.sleep(2)
    
    pyautogui.write("357200223115126760")
    time.sleep(3)
    ...
    pyautogui.write("90000") #---------เพิ่ม validate log ทุก action //  handle function //util
    time.sleep(3)

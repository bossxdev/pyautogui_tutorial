...
def run_test_case():
    ...
    # กรอกรหัสบาร์โค้ด
    log_action("Write", "พิมพ์บาร์โค้ด 010753700264803")
    pyautogui.keyDown('shift')
    pyautogui.press('\\')
    pyautogui.keyUp('shift')
    write_text("010753700264803", delay=3, description="กรอกบาร์โค้ดแรก")
    ...
    pyautogui.press('\\')
    pyautogui.keyUp('shift')
    write_text("10099", delay=3, description="กรอกบาร์โค้ดสุดท้าย")

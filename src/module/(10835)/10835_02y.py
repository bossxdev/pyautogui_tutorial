...
def run_test_case():
    ...
    # กรอกรหัสบาร์โค้ด
    log_action("Write", "พิมพ์บาร์โค้ด 010753700264802")
    pyautogui.keyDown('shift')
    pyautogui.press('\\')
    pyautogui.keyUp('shift')
    write_text("010753700264802", delay=3, description="กรอกบาร์โค้ดแรก")
    ...
    pyautogui.press('\\')
    pyautogui.keyUp('shift')
    write_text("4900000", delay=3, description="กรอกบาร์โค้ดสุดท้าย")

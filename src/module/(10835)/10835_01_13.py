...
def run_test_case():
    ...
    try:
        ...
        write_text("0107537002648", delay=2, description="กรอกรหัสบาร์โค้ด")
        ...
        click((361, 339), delay=5, description="คลิกเลือกสินเชื่อบุคคล")
        ...
        time.sleep(20)
        # กรอกจำนวนเงิน
        write_text("1.23", delay=4, description="กรอกจำนวนเงิน")

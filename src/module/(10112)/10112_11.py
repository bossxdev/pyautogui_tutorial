...
def run_test_case():
    ...
    write_text("0994000575955", delay=2, description="กรอกบาร์โค้ด 1")
    pyautogui.press('enter')

    time.sleep(10)

    write_text("0138980105", delay=2, description="กรอกบาร์โค้ด 2")
    pyautogui.press('enter')
    time.sleep(8)

    write_text("29116740", delay=2, description="กรอกบาร์โค้ด 3")
    pyautogui.press('enter')
    time.sleep(20)

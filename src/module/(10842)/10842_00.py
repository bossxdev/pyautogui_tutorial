...
def run_test_case():
    ...
    # กรอกรหัสบาร์โค้ด
    write_text("045556000089900", delay=2, description="กรอกบาร์โค้ด")
    pyautogui.press('enter')
    time.sleep(14)

    # กรอกรายละเอียดรหัสอ้างอิง
    write_text("2000020010157", delay=2, description="กรอกรหัสอ้างอิง")
    pyautogui.press('enter')
    time.sleep(8)

    write_text("4711316837757", delay=2, description="กรอกรหัสอ้างอิงที่สอง")
    pyautogui.press('enter')
    time.sleep(8)

    # กรอกเบอร์โทรศัพท์จากเครื่อง EDC
    write_text("5000", delay=2, description="กรอกเบอร์โทรศัพท์จากเครื่อง EDC")
